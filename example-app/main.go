...
func cmd() *cobra.Command {
	...
	c.Flags().StringVar(&a.clientID, "client-id", "1055317614162-72a63spttdd8uc1kdl6gbhn5t879hqe6.apps.googleusercontent.com", "OAuth2 client ID of this application.")
	c.Flags().StringVar(&a.clientSecret, "client-secret", "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", "OAuth2 client secret of this application.")
