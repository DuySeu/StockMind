        ...
        messages.map((message, index) => {
          if (message.role === "user" && message.content[0].type === "text") {
            return (
              <div
                key={index}
                className="self-end max-w-[85%] rounded-2xl bg-primary text-primary-foreground px-3 py-2 shadow-sm"
              >
            ...
            return (
              <div key={index} className="self-start rounded-2xl text-secondary-foreground px-3 py-2">
